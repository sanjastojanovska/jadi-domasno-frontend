...
const WidgetSteps: React.FC<Props> = (props) => {
    return (
      ...
      <div className="steps-cont">
        ...
        <div className="grid-item">
          <div className="grid-item-inner">
            <img src="./images/steps3.svg" alt="" />
          </div>
          <div className="grid-item-inner-sec">
            <p className="heading">Подгответе ги вашите нарачки</p>
            <p>
              Регистрирајте се. Прочитајте и пополнете регулативи за безбедност
              на храната и изберете го вашето мени со јадења
            </p>
        ...
        <div className="grid-item">
          <div className="grid-item-inner">
            <img src="./images/steps4.svg" alt="" />
          </div>
          <div className="grid-item-inner-sec">
            <p className="heading">Подгответе ги за испорака</p>
            <p>
              Регистрирајте се. Прочитајте и пополнете регулативи за безбедност
              на храната и изберете го вашето мени со јадења
            </p>
